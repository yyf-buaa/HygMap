...
vectors = np.load('/home/panda/private/jjw/raw_data/sf/poimap_sf/sem_mtx.npy')
sim_mtx = cosine_similarity(vectors)
threshold = 0.97
indices = np.where(sim_mtx>threshold)
indices = list(zip(indices[0],indices[1]))
i = 0
with open('/home/panda/private/jjw/raw_data/sf/poimap_sf/poimap_sf.sem','w') as file:
