...
poi_df = pd.read_csv("/home/jjw/private/raw_data/pt/poimap_pt/poimap_pt.geo")
poi_type_list = poi_df['poi_type'].values
sem_mtx = encode_sentences(poi_type_list)
np.save('/home/jjw/private/raw_data/pt/poimap_pt/sem_mtx.npy',sem_mtx)
