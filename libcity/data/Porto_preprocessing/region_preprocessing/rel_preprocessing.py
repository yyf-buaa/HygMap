...
#计算两条路之间的dist
geo_df = pd.read_csv("/home/panda/private/jjw/raw_data/pt/regionmap_pt/regionmap_pt.geo")
weight = []
polyons = []
for i in tqdm(range(len(geo_df))):
    polyons.append(wkt.loads(geo_df.loc[i,'coordinates']))
for i in tqdm(range(len(geo_df))):
...
rel_df.to_csv("/home/panda/private/jjw/raw_data/pt/regionmap_pt/regionmap_pt.rel")
