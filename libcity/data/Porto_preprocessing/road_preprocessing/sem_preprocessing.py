...
for i in tqdm(range(road_num)):
    region_list = rel_df[(rel_df['rel_type'] == 'road2region') & (rel_df['origin_id'] == i+region_num)]['destination_id'].values
    result_str = ''
    for region in region_list:
        poi_list = rel_df[(rel_df['rel_type'] == 'region2poi') & (rel_df['origin_id'] == region)]['destination_id'].values
        for poi in poi_list:
...
file_path = '/home/panda/private/jjw/raw_data/porto/road_poi_doc.txt'
...
np.save('/home/panda/private/jjw/raw_data/porto/road_tf_matrix.npy',dense_tf_matrix)
#
import numpy as np
from sklearn.metrics.pairwise import cosine_similarity
import pandas as pd
from tqdm import tqdm
vectors = np.load('/home/panda/private/jjw/raw_data/porto/road_tf_matrix.npy')
sim_mtx = cosine_similarity(vectors)
non_zero_indices = np.where(sim_mtx>0.5)
...
for indice in tqdm(indices):
    ...
    i = i+1
result_df.to_csv("/home/panda/private/jjw/raw_data/pt/roadmap_pt/roadmap_pt.sem")